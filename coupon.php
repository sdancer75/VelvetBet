      ...
      <TR>
        ...
        <TR>
            <TD width="100%" align="left">
                ...
                <table>
                <tr>
                    <td bgcolor="#FFD700" class=TextInfo style="TEXT-ALIGN :center;COLOR:BLACK" height=15 width="1120px">
                            ...
                            var MiddlePeriodDate = new Date('<?php echo date("Y M d",$MiddleDateBetweenPeriods)?>');
        ...
        <TR>
            <TD class="yui-skin-sam" style="FONT-SIZE: 10px;"  valign="top" width="100%" align="left">
                   <div id="coupon" align="center"></div>
            </TD>
        </TR>
        <TR>
         ...
         // Define a custom formatter for the Column labeled "flag"
           ...
           var CustomformatNumber = function(elCell, oRecord, oColumn, oData) {
            ...
            var myColumnDefs = [
                ...
                {key:"Goal_1", label:"1", formatter:CustomformatNumber,sortable:false,width:30 },
                {key:"HomeTeam", label:"ΓΗΠΕΔΟΥΧΟΣ", sortable:false, width:150},
                {key:"Goal_x", label:"X",formatter:CustomformatNumber,sortable:false, width:30},
                {key:"HostTeam", label:"ΦΙΛΟΞΕΝΟΥΜΕΝΗ", sortable:false, width:150},
                {key:"Goal_2", label:"2", formatter:CustomformatNumber ,sortable:false, width:30},
                {label:"ΕΙΔΙΚΑ ΣΤΟΙΧΗΜΑΤΑ",
	                    children: [
                            {key:"Under", label:"Under", formatter:CustomformatNumber,sortable:true},
                            {key:"Over", label:"Over", formatter:CustomformatNumber,sortable:true},
                            {key:"GG", label:"GG",  formatter:CustomformatNumber,sortable:true},
                            {key:"NG", label:"NG", formatter:CustomformatNumber,sortable:true}
                        ]
                },
                {key:"Special", label:"ΕΙΔΙΚΑ", editor:elDropDownSpecials, formatter:formatSpecials, width:80}                
