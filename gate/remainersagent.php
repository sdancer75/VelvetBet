     ...
     <Script type="text/javascript">
        ...
        var superagentdropdown= document.getElementById('superagentsmenu');
         ...
         function onFind(p_oEvent) {
             ...
             var sqlquery = "query=sagentremainer&type=select&id=" + ViewSuperAgentFilter + "&whereID=SQL|Date(DateTime) >=@" + StartDate + "@ AND Date(DateTime) <= @"+ EndDate +"@";
        ...
        oMenuButton3.getMenu().subscribe("click", onMenuclickSuperAgent);
          ...
          YAHOO.example.userslist =  function() {
           ...
           var myColumnDefs = [
                ...
                {key:"SName", label:"SAGENT", sortable:false },
                {key:"Name", label:"AGENT", formatter:NameFormatter,sortable:false },
                {key:"Bet", label:"Σ.ΚΛΕΙΣΤΩΝ", formatter:YAHOO.widget.DataTable.formatCurrency, sortable:false},
                {key:"Profit", label:"Σ.ΚΕΡΔΙΣΜΕΝΩΝ",  formatter:YAHOO.widget.DataTable.formatCurrency,  sortable:false},
                {key:"Commission", label:"ΠΡΟΜ. AGENT", formatter:YAHOO.widget.DataTable.formatCurrency, sortable:false},
                {key:"Mixed", label:"ΜΕΙΚΤΟ",width:100,  formatter:YAHOO.widget.DataTable.formatCurrency, sortable:false},
                {key:"Commission_SAgent", label:"ΠΡΟΜ. SAGENT", formatter:WinLoseFormatter, sortable:false},
                {key:"Final", label:"ΚΑΘΑΡΟ",width:100,  formatter:WinLoseFormatter, sortable:false},
                {key:"BetSum", label:"ΑΡ.ΚΛΕΙΣΤΩΝ", formatter:YAHOO.widget.DataTable.formatNumber ,sortable:false},
                {key:"OpenBetSum", label:"ΑΡ.ΑΝΟΙΧΤΩΝ", formatter:YAHOO.widget.DataTable.formatNumber ,sortable:false},
                {key:"OpenBet", label:"Σ.ΑΝΟΙΧΤΩΝ", formatter:YAHOO.widget.DataTable.formatCurrency ,sortable:false}
            ...
            var oConfigs = {
                    ...
                    initialRequest:"query=sagentremainer&type=select&id=" + ViewSuperAgentFilter +"&whereID=SQL|Date(DateTime) >=@" + StartDate + "@ AND Date(DateTime) <= @"+ EndDate +"@",
