...
-->
  <TR>
    <TD class=DummyPrint bgcolor="#CCCC99" style="FONT-SIZE:14px" colSpan=2  height="25px" align="center">
                <strong>Εκκαθάριση Βάσης Δεδομένων</strong>
    </TD>
  </TR>
        ...
        <TR>
            <TD class="yui-skin-sam" style="FONT-SIZE: 11px;"  valign="top" width="100%" style="FONT-SIZE: 10px;">
                ...
                <div id="tvcontainer" class="yui-navset">
                    ...
                    <ul class="yui-nav">
                        <li class="selected"><a href="#tab1"><em>Εκκαθάριση υπολοίπου ΒΔ</em></a></li>
                    </ul>
                      ...
                      <tr>
                        <td align=left>
                                          ...
                                          <script type="text/javascript">
                                            ...
                                            <br><br>
                                            Πληκτρολογήστε στον κωδικό ασφαλείας<br><br>
                                            <input type="text" id="seccode" name="seccode" value="">
                                          <br><br>
                                          <span id="pushbuttonDelete" class="yui-button yui-push-button">
                                          <strong class="first-child">
                                            <button type="button" name="pushbuttonDelete">Εκκαθάριση</button>
                                          </strong>
                                          </span>
                      </td>
                      </tr>
     ...
     <Script type="text/javascript">
        ...
        var ViewAgentFilter = '*';
         ...
         function onDelete(p_oEvent) {
                ...
                var seccode=YAHOO.util.Dom.get("seccode").value;

                if (seccode.length == 0) {

                        YAHOO.example.alert('Παρακαλώ πληκτρολογήστε τον κωδικό ασφαλείας');
                        return;
                }
             ...
             var sqlquery = "query=deleteremainer&type=delete&newvalue="+seccode+"&whereID=SQL|Date(DateTime) <=@" + StartDate + "@";
             ...
             YAHOO.util.Connect.asyncRequest('GET', '../includes/dataproxy.php?'+sqlquery, {
                                          success: function(o) {
                                              ...
                                              if (o.responseText=='200')
                                                  ...
                                                  YAHOO.example.alert('Ο κωδικός ασφαλείας ήταν λάθος.');
        ...
        var oPushButtonDelete = new YAHOO.widget.Button("pushbuttonDelete");
        oPushButtonDelete.on("click", onDelete);
