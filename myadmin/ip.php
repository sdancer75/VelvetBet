   ...
   <?php include 'includes/panel.php' ?>
    ...
    <TD style="VERTICAL-ALIGN: top;" width="100%" >
        ...
        <TR>
            <TD class="yui-skin-sam" style="FONT-SIZE: 11px;"  valign="top" width="100%" style="FONT-SIZE: 10px;">
                ...
                <div id="tvcontainer" class="yui-navset">
                    ...
                    <ul class="yui-nav">
                        <li class="selected"><a href="#tab1"><em>Λίστα επισκεπτών/χρηστών</em></a></li>
                    </ul>

                    <div class="yui-content">
                      <br><br>
                      <b>Άμεση εκκαθάριση λίστας</b><br>
   				      <hr width="100%" style="Color:red;"></hr>
                      <br>
                      Η λίστα διαγράφεται αυτόματα μετά την παρεύλευση των 200 καταχωρήσεων. Για άμεση διαγραφή κάντε κλικ στο παρακάτω κουμπί.
                      <br><br>
                       <span id="pushbuttonDelete" class="yui-button yui-push-button">
                        <strong class="first-child">
                          <button type="button" name="pushbuttonDelete">Διαγραφή λίστας</button>
                        </strong>
                        </span>
                        <br><br>
    				    <hr width="100%" style="Color:red;"></hr>
      ...
      <Script type="text/javascript">
        ...
        var DataTable;
         ...
         function onDelete(p_oEvent) {
            ...
            if (confirm('Είσαι σίγουρος για τη διαγραφή ;')) {
                ...
                YAHOO.util.Connect.asyncRequest('GET', '../includes/dataproxy.php?query=guestsip&primaryKey=GuestipID&type=delete',
                                    {
        ...
        var οPushButtonDelete = new YAHOO.widget.Button("pushbuttonDelete");
        οPushButtonDelete.on("click", onDelete);
          ...
          YAHOO.example.userslist =  function() {
           ...
           var myColumnDefs = [
                ...
                {key:"GuestipID", label:"GuestIP", formatter:YAHOO.widget.DataTable.formatNumber, hidden:true, isPrimaryKey:true},
                {key:"Address", label:"ΔΙΕΥΘ. IP", formatter:YAHOO.widget.DataTable.formatString ,sortable:true},
                {key:"Country", label:"ΧΩΡΑ", formatter:YAHOO.widget.DataTable.formatString, sortable:true},
                {key:"VisitDateTime", label:"ΗΜΕΡOMHNIA",  formatter:YAHOO.widget.DataTable.formatString,  sortable:true},
                {key:"User", label:"ΧΡΗΣΤΗΣ", formatter:YAHOO.widget.DataTable.formatString, sortable:true}
            ...
            myDataSource.responseSchema = {
                  ...
                  fields: [
                  {key:"GuestipID",parser:"number"},
                  {key:"Address",parser:"string"},
                  {key:"Country",parser:"string"},
                  {key:"VisitDateTime",parser:"string"},
                  {key:"User",parser:"string"}
                  ],
            ...
            var oConfigs = {
                    ...
                    initialRequest:"query=guestsip&type=select&primaryKey=GuestipID",
