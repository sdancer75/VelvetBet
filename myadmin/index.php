...
-->
  <TR>
    <TD bgcolor="#CCCC99" style="FONT-SIZE:14px" colSpan=2  height="25px" align="center">
                <strong>Κεντρική σελίδα Διαχείρισης</strong>
    </TD>
  </TR>
      ...
      <Table border=0 width="877px">
       ...
       <TR>
            <TD  align="left">
                ...
                <table>
                <tr>
                    <td bgcolor="#8FBC8B" class=TextInfo style="TEXT-ALIGN :center" height=15 width="877px">
        ...
        <TR>
            <TD width="100%" align="left">
                ...
                <table>
                <tr>
                    <td bgcolor="#FFD700" class=TextInfo style="TEXT-ALIGN :center;COLOR:BLACK" height=15 width="877px">
        ...
        var elDropDownSpecials;
          ...
          YAHOO.example.userslist =  function() {
           ...
           var myColumnDefs = [
                ...
                {key:"Descr", label:"Περιγραφή", formatter:YAHOO.widget.DataTable.formatText, sortable:false, width:720}
